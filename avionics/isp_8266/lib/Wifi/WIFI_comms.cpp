...
String wifiServer::getContentType(
    String filename) { // identify sub-file-name and return
...
void wifiServer::webSocketEvent(uint8_t num, WStype_t type, uint8_t *payload,
                                size_t length) {
  String device;
  switch (type) {
