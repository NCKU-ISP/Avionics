...
public:
    ...
    int16_t begin(uint8_t packetType,
                  uint32_t frequencyInHz,
                  int8_t txPowerInDbm);
    int16_t LoRaConfig(uint8_t spreadingFactor,
                       uint8_t bandwidth,
                       uint8_t codingRate,
...
private:
    ...
    void SPIreadCommand(uint8_t cmd,
                        uint8_t *data,
                        uint8_t numBytes,
                        bool waitForBusy = true);
    void SPItransfer(uint8_t cmd,
                     bool write,
                     uint8_t *dataOut,
                     uint8_t *dataIn,
                     uint8_t numBytes,
    ...
    void SetModulationParams(uint8_t spreadingFactor,
                             uint8_t bandwidth,
                             uint8_t codingRate,
