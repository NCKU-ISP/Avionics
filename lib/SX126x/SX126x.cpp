...
int16_t SX126x::begin(uint8_t packetType,
...
int16_t SX126x::LoRaConfig(uint8_t spreadingFactor,
                           uint8_t bandwidth,
                           uint8_t codingRate,
...
//
//----------------------------------------------------------------------------------------------------------------------------
void SX126x::SetPaConfig(uint8_t paDutyCycle,
                         uint8_t hpMax,
                         uint8_t deviceSel,
                         uint8_t paLut)
{
...
//
//----------------------------------------------------------------------------------------------------------------------------
void SX126x::SetDioIrqParams(uint16_t irqMask,
                             uint16_t dio1Mask,
                             uint16_t dio2Mask,
                             uint16_t dio3Mask)
{
...
//
//----------------------------------------------------------------------------------------------------------------------------
void SX126x::SetModulationParams(uint8_t spreadingFactor,
                                 uint8_t bandwidth,
                                 uint8_t codingRate,
...
void SX126x::SPIreadCommand(uint8_t cmd,
                            uint8_t *data,
                            uint8_t numBytes,
                            bool waitForBusy)
{
...
void SX126x::SPItransfer(uint8_t cmd,
                         bool write,
                         uint8_t *dataOut,
                         uint8_t *dataIn,
                         uint8_t numBytes,
